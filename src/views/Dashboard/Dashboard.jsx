                ...
                <Grid container>
                    ...
                    <ItemGrid xs={12} sm={12} md={6}>
                        <RegularCard
                            ...
                            cardSubtitle="New employees on 15th march, 2024"
                            content={
                                <Table
                                    tableHeaderColor="warning"
                                    tableHead={['ID','Name','Salary','Country']}
                                    tableData={[
                                        [ '1' , "kiran ghate" , "36,738" , "pune"] ,
                                        [ '2' , "ajinky sable" , "23,789" , "pune" ] ,
                                        [ '3' , "sanket sable" , "56,142" , "pune" ] ,
                                        [ '4' , "vaibhavi deshmukh" , "38,735" , "pune" ] ,
                                    ]}
                                />
                            }
                        />
